...
if ($_SESSION['Personal_ID']) {
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="message.php" method="post">
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" id="Personal_ID" name="Personal_ID"
                                                   placeholder="Personal_ID" class="span8" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql1 = "insert into LMS.message (Personal_ID,Msg,Date,Time) values ('$Personal_ID','$message',curdate(),curtime())";
