                    ...
                    <div class="span9">
                        <div class="module">
                            ...
                            <div class="module-body">
                                ...
                                <form class="form-horizontal row-fluid" action="edit_student_details.php?id=<?php echo $Personal_ID ?>" method="post">
...
$sql1="update LMS.user set Name='$name', Category='$category', EmailId='$email', MobNo='$mobno', Password='$pswd' where Personal_ID='$Personal_ID'";
